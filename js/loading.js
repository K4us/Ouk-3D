...
(function() {
	...
	function initGlow() {
		...
		function update(dt) {
			...
			var radius = maxRadius*1.3 - amplitude + sizeOffset;
			...
			grd.addColorStop(0,    'hsla(150,'+saturation+'%,50%,0.5)');
			grd.addColorStop(0.125,'hsla(150,'+saturation+'%,50%,0.3828125)');
			grd.addColorStop(0.25, 'hsla(150,'+saturation+'%,50%,0.28125)');
			grd.addColorStop(0.375,'hsla(150,'+saturation+'%,50%,0.1953125)');
			grd.addColorStop(0.5,  'hsla(150,'+saturation+'%,50%,0.125)');
			grd.addColorStop(0.75, 'hsla(150,'+saturation+'%,50%,0.03125)');
			grd.addColorStop(1,    'hsla(150,'+saturation+'%,50%,0.0)');
	...
	function initTips() {
		...
		var tips = [
			...
			"Answering Neang's request",
			"Carving a princess for the Ses",
			"Sanding the Kun",
			"Enrolling Trey",
